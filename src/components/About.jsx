export const About = () => (
  <>
    ...
    <section className="flex flex-col items-center justify-center absolute inset-0">
      <div className="grid grid-cols-2 justify-items-center gap-8 container text-xl">
        <div className="flex flex-col items-center bg-gray-100 w-4/6 h-full p-5 rounded shadow-xl">
        ...
        <div className="flex flex-col items-center bg-gray-100 w-4/6 h-full p-6 rounded shadow-xl">
